...
```sh
git clone https://github.com/EssentialProgrammingKnowledge/MasteringIntegrationTestsNet-ExpenseTracker.git
cd MasteringIntegrationTestsNet-ExpenseTracker
```
